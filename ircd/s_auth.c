 ...
 *
 *   $Id: s_auth.c,v 1.1.1.1 2006/05/27 13:54:24 zipbreake Exp $
 *
 * Changes:
...
static struct {
  ...
  { "NOTICE AUTH :*** Verificando tu nombre de host\r\n",       48 },
  { "NOTICE AUTH :*** Tu host ha sido resuelto\r\n",            43 },
  { "NOTICE AUTH :*** Tu host ha sido resuelto, cached\r\n",    51 },
  { "NOTICE AUTH :*** No se pudo resolver tu host\r\n", 46 },
  { "NOTICE AUTH :*** Comprobando Ident\r\n",                 36 },
  { "NOTICE AUTH :*** Respuesta de ident recibida\r\n",             46 },
  { "NOTICE AUTH :*** No hubo respuesta de ident\r\n",              45 },
  { "NOTICE AUTH :*** Tu DNS real y reverso no coinciden, " \
    "se ignorará tu host.\r\n",                              75 },
  { "NOTICE AUTH :*** Tu host contiene caracteres inválidos\r\n",               56 }
};
 ...
 * RyDeN - 14 Junio 2003
 *
 * Elimino la macro sendheader y creo una función para que en el notice pueda incluirse
 * el nombre del servidor local
 *
 *
 * RyDeN - 26 Abril 2004
 *
 * Reescribimos la rutina optimizando su rendimiento ya que su uso es frecuente
 */
...
static void sendheader(struct Client *cptr, int reportType)
{
        ...
        /* FEAT_RH_PSEUDO_SERVERNAME, mount@redhispana.org */
