 ...
 *
 * $Id: m_topic.c,v 1.4 2009/02/08 14:47:17 zipbreake Exp $
 */
		        ...
		        struct Channel *chptr,char *topic)
{
   ...
   if ((chptr->mode.mode & MODE_TOPICLIMIT) != 0 &&
	   !is_chan_op(sptr, chptr) && !is_chan_owner(sptr, chptr) && !is_chan_halfop(sptr, chptr)
	   && !IsBot(sptr) && !es_representante(sptr)) 
   {
