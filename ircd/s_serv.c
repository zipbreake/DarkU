 ...
 *
 * $Id: s_serv.c,v 1.1.1.1 2006/05/27 13:54:37 zipbreake Exp $
 */
#include "config.h"
...
/*    nextping = CurrentTime; */
   ...
   * -- RyDeN
   * 01 de mayo de 2003
   * Si es hub el servidor en cuestión, le solicitamos las DBs
   *
   */

  sendcmdto_one(&me, CMD_DB, cptr, "* 0 J 0 %i", BDD_VERSION);

  acepta_negociaciones(cptr, 0);
  /*
