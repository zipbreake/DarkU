 ...
 *
 * $Id: s_err.c,v 1.20 2010/06/03 08:21:49 zipbreake Exp $
 */
#include "config.h"
...
/* 004 */
  { RPL_MYINFO, "%s %s ABIRSWXabcdghiknoprswxz CGMNORSZcijlmnprstrux bhklov", "004" },
/* 005 */
...
/* 313 */
  { RPL_WHOISOPERATOR, "%s :es un IRCop del servidor", "313" },
/* 314 */
  { RPL_WHOWASUSER, "%s %s %s * :%s", "314" },
/* 315 */
  { RPL_ENDOFWHO, "%s :Fin del /WHO list.", "315" },
/* 316 */
  { RPL_WHOISBOT, "%s :es un BOT %s de %s", "316" },
/* 317 */
...
/* 397 */
  {RPL_REALNAMEIS, "%s :es ahora tu Nombre para mostrar", "397"},
/* 398 */
  { 0 },
/* 399 */
  { 0 },
...
/* 404 */
  { ERR_CANNOTSENDTOCHAN, "%s :No puede enviar mensajes al canal (%s)", "404" },
/* 405 */
...
/* 408 */
  { ERR_NOCOLORSCHAN, "%s :No puede enviar colores al canal (+C)", "408" },
/* 409 */
...
/* 481 */
  { ERR_NOPRIVILEGES, ":Permiso denegado: No tienes permisos suficientes", "481" },
/* 482 */
...
/* 485 */
  { ERR_NEEDSECURENICK, "%s :No puedes entrar al canal. Canal sólo para usuarios registrados o securizados (+Z)", "485" },
/* 486 */
  { ERR_NOTCREATECHANNEL, "%s :El canal no está registrado. Para utilizarlo registralo.", "486" },
/* 487 */
  { 0 },
/* 488 */
  { 0 },
