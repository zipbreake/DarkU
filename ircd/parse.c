 ...
 *
 * $Id: parse.c,v 1.12 2010/04/29 08:05:22 zipbreake Exp $
 */
#include "config.h"
...
//  },
...

  {
    ...
    0, MAXPARA, 0, 0,
    /* UNREG, CLIENT, SERVER, OPER, SERVICE */
    { m_ignore, m_ignore, m_db, m_ignore, m_ignore }
  },
...

  {
    ...
    0, 3, 0, 0,
    /* UNREG, CLIENT, SERVER, OPER, SERVICE */
    { ms_protoctl, m_ignore, ms_protoctl, m_ignore, m_ignore }
  },

  {
    ...
    0, 2, 0, 0,
    /* UNREG, CLIENT, SERVER, OPER, SERVICE */
    { m_ignore, m_ignore, m_rc4key, m_ignore, m_ignore }
  },

  {
	...
	TOK_GHOST,
	0, 2, MFLG_SLOW, 0,
	{ m_ghost, m_ghost, ms_ghost, m_ghost, m_ignore }
  },

  {
	...
	TOK_DBQ,
	0, MAXPARA, MFLG_SLOW, 0,
	{ m_unregistered, m_dbq, m_dbq, m_dbq, m_ignore }
  },

  {
	...
	TOK_CIFRANICK,
	0, 2, MFLG_SLOW, 0,
	{ m_unregistered, m_cifranick, m_ignore, m_cifranick, m_ignore }
  },

  {
	...
	TOK_USERS,
	0, MAXPARA, MFLG_SLOW, 0,
	{ m_unregistered, m_users, m_users, m_users, m_ignore }
  },

  {
	...
	TOK_RENAME,
	0, MAXPARA, 0, 0,
	{ m_ignore, m_ignore, m_rename, m_ignore, m_ignore }
  },

  {
	...
	TOK_TBURST,
	0, 5, 0, 0,
	{ m_ignore, m_ignore, m_tburst, m_ignore, m_ignore }
  },

  {
	...
	TOK_BMODE,
	0, MAXPARA, 0, 0,
	{ m_ignore, m_ignore, m_bmode, m_ignore, m_ignore }
  },

  {
	...
	TOK_SECURE,
	0, 1, 0, 0,
	{ m_ignore, m_ignore, m_secure, m_ignore, m_ignore }
  },
...
int parse_server(struct Client *cptr, char *buffer, char *bufend)
{
  ...
  else
  {
     ...
     */
    if (!mptr)
      mptr = msg_tree_parse_client(ch, &msg_tree_cmd);
#endif /* 1 */
