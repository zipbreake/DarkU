 ...
 *
 * $Id: s_misc.c,v 1.1.1.1 2006/05/27 13:54:37 zipbreake Exp $
 */
#include "config.h"
  ...
  if (MyConnect(victim)) {
    ...
    if (feature_bool(FEAT_CONNEXIT_NOTICES) && IsUser(victim))
      sendto_opmask_butone(0, SNO_CONNEXIT,
			   ...
			   get_virtualhost(victim), comment,
