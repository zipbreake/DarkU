 ...
 *
 * $Id: channel.h,v 1.12 2010/04/29 07:47:20 zipbreake Exp $
 */
...
#define CHFL_VOICED_OR_OPPED (CHFL_CHANOP | CHFL_VOICE | CHFL_HALFOP)
...
#define RHMODE_NOCOLORNOT	0x0040
#define RHMODE_NONOTICES	0x0080
 ...
 */
#define MODE_WPARAS     (MODE_CHANOP|MODE_VOICE|MODE_BAN|MODE_KEY|MODE_LIMIT|RHMODE_HALFOP)
...
#define MODEBUF_DEST_XMODE	0x40000 /* Se ha recibido un X-Mode */
