 ...
 *
 * $Id: gline.h,v 1.2 2010/06/16 10:08:37 zipbreake Exp $
 */
...
#define GLINE_NOWEB	0x0800	/* gline is not for webchat users */
...
#define GlineNoWebchat(g)	((g)->gl_flags & GLINE_NOWEB)
