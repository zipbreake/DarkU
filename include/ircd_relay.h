 ...
 *
 * $Id: ircd_relay.h,v 1.2 2010/06/03 08:21:49 zipbreake Exp $
 */
...
extern void relay_private_message(struct Client* cptr, struct Client* sptr, const char* name, const char* text);
extern void relay_private_notice(struct Client* cptr, struct Client* sptr, const char* name, const char* text);
